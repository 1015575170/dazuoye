...
@Component({
  selector: 'app-szwmanagement',
  templateUrl: './szwmanagement.component.html',
  styleUrls: ['./szwmanagement.component.css']
})
export class SzwmanagementComponent implements OnInit {
  myForm:FormGroup;
